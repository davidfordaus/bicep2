...
resource nicResource 'Microsoft.Network/networkInterfaces@2018-10-01' = {
  name: name
  properties: {
    ...
    ipConfigurations: [
      {
        ...
        properties: {
          ...
          subnet: { 
            id: '/subscriptions/a1df2b46-08c4-4d8a-b078-6beb5047606b/resourceGroups/${resourceGroup()}/providers/Microsoft.Network/virtualNetworks/${vnetName}/subnets/${subnetName}'
          }
          primary: true
